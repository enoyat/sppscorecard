...
@slot('title') Edit OFFICIAL REPORT @endslot
@endcomponent
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                    ...
                                    <input class="form-control" type="date" value="{{ $beritaacara->tanggalterima }}" name="tanggalterima"
                                        id="tanggalterima">
                                </div>
                                <div class="mb-3">
                                    <label for="example-week-input" class="form-label">Penerima</label>
                                    <input class="form-control" type="text" value="{{ $beritaacara->namapenerima }}" name="namapenerima"
                                        id="namapenerima">
                                </div>
                                <div class="mb-3">
                                    <label for="example-week-input" class="form-label">Tanggal Kembali</label>
                                    <input class="form-control" type="date" value="{{ $beritaacara->tanggalkembali }}" name="tanggalkembali"
                                        id="tanggalkembali">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Status SPP</label>
                                    <select class="form-select" name="statuspengirim" id="statuspengirim">
                                    <option value="{{ $beritaacara->statuspengirim }}">{{ $beritaacara->statuspengirim }}</option>
