...
<table width="700" border="0" cellpadding="0" cellspacing="0" style="font-size: 13px">
    <tr style="height: 100px">
        <td ><img src="{{ asset('/img/logo.png') }}" width="60px"></td>
...
<br>
        <table width="700" height="21" border="1"  cellspacing="0" bordercolor="#000000" class="grid" style="font-size: 11px" id="example">
        <tr bgcolor="#CCCCCC">
            <th>
                No
            </th>
