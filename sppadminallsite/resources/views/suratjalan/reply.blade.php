...
@slot('title') REPLY DELIVERY NOTE  @endslot
@endcomponent
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">REPLY DELIVERY NOTE </h4>
            </div>
            <div class="card-body p-4">

                <form action="{{ route('suratjalan.reply',$suratjalan->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div>
                                <div class="mb-3">
                                    <label for="example-password-input" class="form-label">FOTO REPLY DELIVERY NOTE </label>
