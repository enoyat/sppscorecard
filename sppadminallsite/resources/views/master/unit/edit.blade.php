                            ...
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" value="{{ $unit->equipment }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" value="{{ $unit->serialnumber }}"
                                            name="serialnumber" id="serialnumber">

                                    </div>
                                    <div class="mb-3">
                                        <label for="example-password-input" class="form-label">Specification</label>
                                        <input class="form-control" type="text" value="{{ $unit->specification }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" value="{{ $unit->masheight }}"
                                    ...
                                    @if ($unit->file_silo)
                                        <div class="row mb-3">
                                            <label class="form-label">Pre-view Silo</label>
                                            <a href="#" class="previewImage" data-id="{{ $unit->kdunit }}">
                                                <img src="{{ asset('/img/' . $unit->file_silo) }}"
