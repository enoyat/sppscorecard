                            ...
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" value="" name="equipment"
                                            id="equipment">
                                    </div>
                                    <div class="mb-3">
                                        <label for="example-password-input" class="form-label">Merk</label>
                                        <input class="form-control" type="text" value="" name="merk"
                                            id="merk">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" value="" name="model"
                                            id="model">
                                    </div>
                                    <div class="mb-3">
                                        <label for="example-password-input" class="form-label">Capcity</label>
                                        <input class="form-control" type="text" value="" name="capcity"
                                            id="capcity">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" value="" name="specification"
                                            id="specification">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-6">
                                            ...
                                            <input type="file" name="fileSilo" id="fileSilo" class="form-control"
