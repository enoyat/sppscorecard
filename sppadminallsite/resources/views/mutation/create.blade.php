...
@section('content')
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" aria-label="Default select example"
                                            name="idsitenameasal" id="idsitenameasal">
                                ...
                                <div class="mb-3">
                                    ...
                                    <small>Isi dengan kode unit yang baru (bila replace kode). isikan dengan kodelama jika
                                        hanya mutasi site </small>
    ...
    <script>
        ...
        $('#idcbu').on('select2:select', function(e) {

            let id = e.params.data.id;

            $('#idregion').html('<option value="">Loading...</option>');

            $.ajax({
                url: "{{ url('/lokasi/getregion') }}/" + id,
                type: 'GET',
                dataType: 'json',
                success: function(data) {
                    ...
                    $.each(data, function(i, item) {
                        html += `<option value="${item.id}">${item.namasitename}</option>`;
                    });
        ...
        $('#idregion').on('change', function() {
            ...
            $('#idsitename').html('<option value="">Loading...</option>');

            $.ajax({
                url: "{{ url('/lokasi/getsitename') }}/" + id,
                type: 'GET',
                dataType: 'json',
                success: function(data) {
        ...
        $('#idcbu').select2({
            placeholder: 'Pilih CBU',
            width: '100%',
            allowClear: true,
            ajax: {
                url: "{{ route('lokasi.getallcbu') }}",
                dataType: 'json',
                delay: 250,
