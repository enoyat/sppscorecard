...
@section('title') palleterenew @endsection
...
@slot('li_1') palleterenew @endslot
@slot('title') palleterenew @endslot
@endcomponent
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
            <div>
                <ul class="nav nav-pills">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('palleterenew.index') }}" data-bs-toggle="tooltip"
            ...
            <div>
                <a href="{{ route('palleterenew.create') }}" class="btn btn-light"><i class="bx bx-plus me-1"></i> Add New</a>
            </div>
