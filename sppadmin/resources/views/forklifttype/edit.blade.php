...
@slot('title') Update forklifttype @endslot
@endcomponent
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" value="{{ $forklifttype->namaforklifttype }}" name="namaforklifttype" id="namaforklifttype">
                                </div>
                                <div class="mb-3">
