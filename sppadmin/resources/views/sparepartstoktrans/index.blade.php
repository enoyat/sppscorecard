...
@slot('li_1') Sparepart Transaction @endslot
@slot('title') sparepart Transaction @endslot
@endcomponent
...
<div class="row align-items-center">
    ...
    <div class="col-md-6">
        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
            ...
            <div>
                <a href="{{ route('sparepartstoktrans.create') }}" class="btn btn-light"><i class="bx bx-plus me-1"></i> Add New</a>
            </div>
...
<div class="table-responsive mb-4" id="tablecontent">
    @include('sparepartstoktrans.content')
