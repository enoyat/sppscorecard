...
@slot('li_1') pallete @endslot
@slot('title') pallete @endslot
@endcomponent
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
            <div>
                <ul class="nav nav-pills">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('pallete.index') }}" data-bs-toggle="tooltip"
            ...
            <div>
                <a href="{{ route('pallete.create') }}" class="btn btn-light"><i class="bx bx-plus me-1"></i> Add New</a>
            </div>
