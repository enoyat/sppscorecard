        ...
        <div class="col-12">
            ...
            <div class="email-leftbar card">
                <div class="mail-list mt-4">
                    ...
                    <a href="#" class="active"><i class="mdi mdi-email-outline me-2"></i> Open <span
                            class="ms-1 float-end">(18)</span></a>
                    <a href="#"><i class="mdi mdi-star-outline me-2"></i>Closed</a>
                </div>
                    ...
                    <ul class="message-list">
                        ...
                        <li>
                            ...
                            <div class="col-mail col-mail-1">
                                #{{ $key->id }}
                                <a href="{{ route('ticket.read',$key->id)}}" class="title">{{ $key->getuser->name }}</a><span class="star-toggle far fa-star"></span>
