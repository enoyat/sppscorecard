...
import 'package:scorecardapps/models/dokumentrouble.dart';
...
class FormUploadTrouble extends StatefulWidget {
  const FormUploadTrouble({
    super.key,
  ...
  @override
  State<FormUploadTrouble> createState() => _FormUploadTroubleState();
}

class _FormUploadTroubleState extends State<FormUploadTrouble> {
  ...
  setter() async {
    ...
    setState(() {
      ...
      baseurlweb = prefs.getString('urlweb');
    });
  }
  ...
  void refreshData() {
    ...
    TroubleDio().listdokumen(widget.idaction).then((value) {
      setState(() {
        _listdokumen = value;
        isLoading = false;
      });
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return Container(
                              ...
                              child: Card(
                                  child: Image.network(
                                '$baseurlweb/assets/inventory/${_listdokumen[index].filename}',
                              )),
                            );
                          }),
                    ),
