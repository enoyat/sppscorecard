...
import 'package:scorecardapps/services/network_manager.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  void _setter() async {
    ...
    await prefs.setString('idsitename', idsitename);
    ...
    await prefs.setString('urlweb', urlweb);
  }
                              ...
                              onPressed: () async {
                                ...
                                if (isValid) {
                                  ...
                                  if (pilihurl == 'Danone') {
                                    ...
                                    urlweb =
                                        'https://danone.satriapirantiperkasa.com';
                                  } else {
                                    urlapi =
                                        'https://allsite.satriapirantiperkasa.com/api';
                                    urlweb =
                                        'https://allsite.satriapirantiperkasa.com';
                                  }
