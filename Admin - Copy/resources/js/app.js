/*
Template Name: Satria Piranti Perkasa - Bootstrap 5 Admin & Dashboard Template
Author: Themesbrand
Version: 2.0.0
...
(function ($) {
    ...
    var language = localStorage.getItem('Satria Piranti Perkasa-language');
    // Default Language
    var default_lang = 'en';
    ...
    function setLanguage(lang) {
        if (document.getElementById("header-lang-img")) {
            ...
            localStorage.setItem('Satria Piranti Perkasa-language', lang);
            language = localStorage.getItem('Satria Piranti Perkasa-language');
            getLanguage();
        }
    }
    ...
    function layoutSetting() {
        ...
        $("input[name='layout-direction']").on('change', function () {
            if($(this).val() == "ltr") {
                ...
                // document.getElementById('bootstrap-style').setAttribute('href', 'build/css/bootstrap-rtl.min.css');
                document.getElementById('app-style').setAttribute('href', '/build/css/app-rtl.min.css');
