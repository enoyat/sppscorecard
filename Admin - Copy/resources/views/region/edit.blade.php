...
@slot('title') Update region @endslot
@endcomponent
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="namaregion" value="{{ $region->namaregion }}" id="namaregion" placeholder="">
                            </div>
                            <div class="mb-3">
                                ...
                                <option value="{{ $region->idcbu }}" selected>{{ $region->getcbu->namacbu }}</option>    
