...
@section('title') @lang('translation.Blog_detail') @endsection
        ...
        <div class="card">
            <div class="card-body">
                <div class="">
                    ...
                    <div class="mb-4">
                        <img src="build/images/small/img-2.jpg" alt="" class="img-thumbnail mx-auto d-block">
                    </div>
                        ...
                        <div class="mt-5">
                            ...
                            <div>
                                ...
                                <div class="d-flex py-3 border-top">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar-xs">
                                            <img src="build/images/users/avatar-2.jpg" alt="" class="img-fluid d-block rounded-circle">
                                        </div>
                                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-5">
                        ...
                        <ul class="list-unstyled fw-medium px-2">
                            <li><a href="javascript: void(0);" class="text-body pb-3 d-block border-bottom">Design<span class="badge badge-soft-primary badge-pill ms-1 float-end font-size-12">02</span></a></li>
                            <li><a href="javascript: void(0);" class="text-body py-3 d-block border-bottom">Development <span class="badge badge-soft-primary badge-pill float-end ms-1 font-size-12">04</span></a></li>
                            <li><a href="javascript: void(0);" class="text-body py-3 d-block border-bottom">Business<span class="badge badge-soft-primary badge-pill ms-1 float-end font-size-12">12</span></a></li>
                            <li><a href="javascript: void(0);" class="text-body py-3 d-block border-bottom">Project<span class="badge badge-soft-primary badge-pill ms-1 float-end font-size-12">08</span></a></li>
                            <li><a href="javascript: void(0);" class="text-body pt-3 pb-0 d-block">Travel<span class="badge badge-soft-primary badge-pill ms-1 float-end font-size-12">10</span></a></li>
                        </ul>
                    </div>
                    <div class="mt-5">
                        ...
                        <div class="list-group list-group-flush">
                            <a href="javascript: void(0);" class="list-group-item text-muted pb-3 pt-0 px-2">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 me-3">
                                        <img src="build/images/small/img-7.jpg" alt="" class="avatar-lg h-auto d-block rounded">
                                    </div>
                            ...
                            <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 me-3">
                                        <img src="build/images/small/img-2.jpg" alt="" class="avatar-lg h-auto d-block rounded">
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                            ...
                            <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 me-3">
                                        <img src="build/images/small/img-6.jpg" alt="" class="avatar-lg h-auto d-block rounded">
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                            ...
                            <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 me-3">
                                        <img src="build/images/small/img-1.jpg" alt="" class="avatar-lg h-auto d-block rounded">
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="list-group list-group-flush">
                            <a href="javascript: void(0);" class="list-group-item text-muted pb-3 pt-0 px-2">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 me-3">
                                        <img src="build/images/small/img-3.jpg" alt="" class="avatar-xl h-auto d-block rounded">
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="font-size-13 text-truncate">Beautiful Day with Friends</h5>
                            ...
                            <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 me-3">
                                        <img src="build/images/small/img-4.jpg" alt="" class="avatar-xl h-auto d-block rounded">
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="font-size-13 text-truncate">Drawing a sketch</h5>
                            ...
                            <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 me-3">
                                        <img src="build/images/small/img-1.jpg" alt="" class="avatar-xl h-auto d-block rounded">
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="font-size-13 text-truncate">Coffee with friends</h5>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="gap-2 hstack flex-wrap px-2">
                            <img src="build/images/small/img-3.jpg" alt="" class="avatar-xl rounded">
                            <img src="build/images/small/img-1.jpg" alt="" class="avatar-xl rounded">
                            <img src="build/images/small/img-2.jpg" alt="" class="avatar-xl rounded">
                            <img src="build/images/small/img-4.jpg" alt="" class="avatar-xl rounded">
                            <img src="build/images/small/img-5.jpg" alt="" class="avatar-xl rounded">
                            <img src="build/images/small/img-6.jpg" alt="" class="avatar-xl rounded">
                        </div>
                    </div>
