...
@section('title') Pallete @endsection

@section('content')

@component('components.breadcrumb')
@slot('li_1') Forms @endslot
@slot('title') Create pallete @endslot
@endcomponent
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('pallete.store') }}" method="POST">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="date" value="" name="targetdate" id="targetdate">
                                </div>
