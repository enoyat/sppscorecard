                        ...
                        <div class="d-flex align-items-start mt-3 mt-sm-0">
                            <div class="flex-shrink-0">
                                <div class="avatar-xl me-3">
                                    <img src="@if (Auth::user()->avatar != ''){{ URL::asset('build/images/users/' . Auth::user()->avatar) }}@else{{ URL::asset('build/images/users/avatar-1.jpg') }}@endif" alt="" class="img-fluid rounded-circle d-block">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xl-4">
                                    <div class="card p-1 mb-xl-0">
                                        ...
                                        <div class="position-relative">
                                            <img src="build/images/small/img-3.jpg" alt="" class="img-thumbnail">
                                        </div>
                                ...
                                <div class="col-xl-4">
                                    <div class="card p-1 mb-xl-0">
                                        ...
                                        <div class="position-relative">
                                            <img src="build/images/small/img-1.jpg" alt="" class="img-thumbnail">
                                        </div>
                                ...
                                <div class="col-xl-4">
                                    <div class="card p-1 mb-sm-0">
                                        ...
                                        <div class="position-relative">
                                            <img src="build/images/small/img-5.jpg" alt="" class="img-thumbnail">
                                        </div>
            ...
            <div class="card-body">
                ...
                <div class="list-group list-group-flush">
                    <a href="#" class="list-group-item list-group-item-action">
                        <div class="d-flex align-items-center">
                            <div class="avatar-sm flex-shrink-0 me-3">
                                <img src="build/images/users/avatar-1.jpg" alt="" class="img-thumbnail rounded-circle">
                            </div>
                            <div class="flex-grow-1">
                                <div>
                    ...
                    <a href="#" class="list-group-item list-group-item-action">
                        <div class="d-flex align-items-center">
                            <div class="avatar-sm flex-shrink-0 me-3">
                                <img src="build/images/users/avatar-3.jpg" alt="" class="img-thumbnail rounded-circle">
                            </div>
                            <div class="flex-grow-1">
                                <div>
                ...
                <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="update-profile">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="text-start mt-2">
                            <img src="@if (Auth::user()->avatar != ''){{ URL::asset('images/' . Auth::user()->avatar) }}@else{{ URL::asset('build/images/users/avatar-1.jpg') }}@endif" alt="" class="rounded-circle avatar-lg">
                        </div>
