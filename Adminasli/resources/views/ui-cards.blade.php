...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6 col-xl-3">
            ...
            <!-- Simple card -->
            <div class="card">
                <img class="card-img-top img-fluid" src="build/images/small/img-1.jpg" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-md-6 col-xl-3">
            ...
            <div class="card">
                <img class="card-img-top img-fluid" src="build/images/small/img-2.jpg" alt="Card image cap">
                <div class="card-body">
                    <h4 class="card-title">Card title</h4>
                    <p class="card-text">Some quick example text to build on the card title and make
                        up the bulk of the card's content.</p>
        ...
        <div class="col-md-6 col-xl-3">
            ...
            <div class="card">
                <img class="card-img-top img-fluid" src="build/images/small/img-3.jpg" alt="Card image cap">
                <div class="card-body">
                    <p class="card-text">Some quick example text to build on the card title and make
                        up the bulk of the card's content.</p>
                </div>
        ...
        <div class="col-md-6 col-xl-3">
            ...
            <div class="card">
                ...
                <img class="img-fluid" src="build/images/small/img-4.jpg" alt="Card image cap">
                <div class="card-body">
                    <p class="card-text">Some quick example text to build on the card title and make
                        up the bulk of the card's content.</p>
                    <a href="javascript: void(0);" class="card-link">Card link</a>
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                <img class="card-img-top img-fluid" src="build/images/small/img-5.jpg" alt="Card image cap">
                <div class="card-body">
                    <h4 class="card-title">Card title</h4>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <img class="card-img-bottom img-fluid" src="build/images/small/img-7.jpg" alt="Card image cap">
            </div>
        </div><!-- end col -->

        <div class="col-lg-4">
            <div class="card">
                <img class="card-img img-fluid" src="build/images/small/img-6.jpg" alt="Card image">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="row g-0 align-items-center">
                    <div class="col-md-4">
                        <img class="card-img img-fluid" src="build/images/small/img-2.jpg" alt="Card image">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="row g-0 align-items-center">
                    ...
                    <div class="col-md-4">
                        <img class="card-img img-fluid" src="build/images/small/img-3.jpg" alt="Card image">
                    </div>
                </div>
            </div>
        </div><!-- end col -->
        ...
        <div class="col-12">
            ...
            <div class="card-deck-wrapper">
                <div class="card-group">
                    <div class="card mb-4">
                        <img class="card-img-top img-fluid" src="build/images/small/img-4.jpg" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title">Card title</h4>
                    ...
                    <div class="card mb-4">
                        <img class="card-img-top img-fluid" src="build/images/small/img-6.jpg" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title">Card title</h4>
        ...
        <div class="col-sm-12">
            ...
            <div class="row" data-masonry='{"percentPosition": true }'>
                <div class="col-sm-6 col-lg-4">
                    <div class="card">
                        <img src="build/images/small/img-3.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card">
                        <img src="build/images/small/img-5.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card">
                        <img src="build/images/small/img-7.jpg" class="card-img-top" alt="...">
                    </div>
                </div><!-- end col -->
...
@section('script')
    ...
    <!-- masonry pkgd -->
    <script src="{{ URL::asset('build/libs/masonry-layout/masonry-layout.min.js') }}"></script>
