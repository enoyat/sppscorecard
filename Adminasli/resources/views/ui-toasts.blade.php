...
@section('title') @lang('translation.Toast') @endsection
                    ...
                    <div class="position-fixed bottom-0 end-0 p-3" style="z-index: 11">
                        <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
                            <div class="toast-header">
                                <img src="build/images/logo-sm.svg" alt="" class="me-2" height="18">
                                <strong class="me-auto">Satria Piranti Perkasa</strong>
                ...
                <div class="card-body">
                    ...
                    <div aria-live="polite" aria-atomic="true" class="bd-example  bg-light-subtle position-relative" style="height: 300px;">
                        <div class="toast-container position-absolute p-3" id="toastPlacement">
                            <div class="toast">
                                <div class="toast-header">
                                    <img src="build/images/logo-sm.svg" class="rounded me-2"
                                        alt="..." height="20">
                                    <strong class="me-auto">Satria Piranti Perkasa</strong>
...
@endsection
@section('script')
        <script src="{{ URL::asset('build/js/pages/bootstrap-toasts.init.js') }}"></script>
    @endsection
