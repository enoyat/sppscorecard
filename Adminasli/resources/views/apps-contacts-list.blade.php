            ...
            <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                <div>
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="apps-contacts-grid" data-bs-toggle="tooltip" data-bs-placement="top"
        ...
        <table class="table align-middle datatable dt-responsive table-check nowrap"
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <img src="build/images/users/avatar-2.jpg" alt="" class="avatar-sm rounded-circle me-2">
                        <a href="#" class="text-body">Phyllis Gatlin</a>
                    </td>
                    <td>UI/UX Designer</td>
                    <td>phyllisgatlin@Satria Piranti Perkasa.com</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <img src="build/images/users/avatar-1.jpg" alt="" class="avatar-sm rounded-circle me-2">
                        <a href="#" class="text-body">James Nix</a>
                    </td>
                    <td>Frontend Developer</td>
                    <td>jamesnix@Satria Piranti Perkasa.com</td>
                    <td>
                        <div class="d-flex gap-2">
                ...
                <tr>
                    ...
                    <td>
                        <img src="build/images/users/avatar-3.jpg" alt="" class="avatar-sm rounded-circle me-2">
                        <a href="#" class="text-body">Darlene Smith</a>
                    </td>
                    <td>Backend Developer</td>
                    <td>darlenesmith@Satria Piranti Perkasa.com</td>
                    <td>
                        <div class="d-flex gap-2">
                ...
                <tr>
                    ...
                    <td>williamswift@Satria Piranti Perkasa.com</td>
                    <td>
                        <div class="d-flex gap-2">
                ...
                <tr>
                    ...
                    <td>Frontend Developer</td>
                    <td>kevinwest@Satria Piranti Perkasa.com</td>
                    <td>
                        <div class="d-flex gap-2">
                            <a href="#" class="badge badge-soft-primary font-size-11">Html</a>
                            <a href="#" class="badge badge-soft-primary font-size-11">Css</a>
                ...
                <tr>
                    ...
                    <td>
                        <img src="build/images/users/avatar-6.jpg" alt="" class="avatar-sm rounded-circle me-2">
                        <a href="#" class="text-body">Tommy Hayes</a>
                    </td>
                    <td>UI/UX Designer</td>
                    <td>tommyhayes@Satria Piranti Perkasa.com</td>
                    <td>
                        <div class="d-flex gap-2">
                ...
                <tr>
                    ...
                    <td>
                        <img src="build/images/users/avatar-8.jpg" alt="" class="avatar-sm rounded-circle me-2">
                        <a href="#" class="text-body">Diana Owens</a>
                    </td>
                    <td>Graphic Designer</td>
                    <td>dianaowens@Satria Piranti Perkasa.com</td>
                    <td>
                        <div class="d-flex gap-2">
                            <a href="#" class="badge badge-soft-primary font-size-11">Photoshop</a>
                            <a href="#" class="badge badge-soft-primary font-size-11">illustrator</a>
                ...
                <tr>
                    ...
                    <td>
                        <img src="build/images/users/avatar-9.jpg" alt="" class="avatar-sm rounded-circle me-2">
                        <a href="#" class="text-body">Paul Sanchez</a>
                    </td>
                    <td>Angular Developer</td>
                    <td>paulsanchez@Satria Piranti Perkasa.com</td>
                    <td>
                        <div class="d-flex gap-2">
                            <a href="#" class="badge badge-soft-primary font-size-11">Php</a>
                ...
                <tr>
                    ...
                    <td>Web Designer</td>
                    <td>peterdryer@Satria Piranti Perkasa.com</td>
                    <td>
                        <div class="d-flex gap-2">
                            <a href="#" class="badge badge-soft-primary font-size-11">Html</a>
                            <a href="#" class="badge badge-soft-primary font-size-11">Css</a>
                ...
                <tr>
                    ...
                    <td>
                        <img src="build/images/users/avatar-4.jpg" alt="" class="avatar-sm rounded-circle me-2">
                        <a href="#" class="text-body">Gerald Moyer</a>
                    </td>
                    <td>Backend Developer</td>
                    <td>geraldmoyer@Satria Piranti Perkasa.com</td>
                    <td>
                        <div class="d-flex gap-2">
                            <a href="#" class="badge badge-soft-primary font-size-11">Php</a>
                            <a href="#" class="badge badge-soft-primary font-size-11">Javascript</a>
                ...
                <tr>
                    ...
                    <td>Backend Developer</td>
                    <td>gailmcGuire@Satria Piranti Perkasa.com</td>
                    <td>
                        <div class="d-flex gap-2">
                            <a href="#" class="badge badge-soft-primary font-size-11">Php</a>
                            <a href="#" class="badge badge-soft-primary font-size-11">Javascript</a>
