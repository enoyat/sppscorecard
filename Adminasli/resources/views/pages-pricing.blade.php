                        ...
                        <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" id="pills-tab"
                            ...
                            <li class="nav-item">
                                <a class="nav-link px-3 rounded yearly" id="yearly" data-bs-toggle="pill" href="#year"
                                    role="tab" aria-controls="year" aria-selected="false">Yearly</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                    ...
                                    <div class="card mb-xl-0">
                                        <div class="card-body">
                                            <div class="p-2">
                                                ...
                                                <h1 class="mt-3">$29 <span class="text-muted font-size-16 fw-medium">/
                                                        Month</span></h1>
                                                <p class="text-muted mt-3 font-size-15">For small teams trying out Satria Piranti Perkasa for
                                                    an unlimited
                                                    period of time</p>
                                    ...
                                    <div class="card mb-xl-0">
                                        <div class="card-body">
                                            <div class="p-2">
                                                ...
                                                <h1 class="mt-3">$49 <span class="text-muted font-size-16 fw-medium">/
                                                        Month</span></h1>
                                                <p class="text-muted mt-3 font-size-15">For larger businesses or those with
                                        ...
                                        <div class="card-body">
                                            <div class="p-2">
                                                ...
                                                <h1 class="mt-3 text-white">$79 <span
                                                        class="text-white font-size-16 fw-medium">/ Month</span></h1>
                                                <p class="text-white-50 mt-3 font-size-15">For extra large businesses or
                                                    those in regulated industries</p>
                                    ...
                                    <div class="card mb-0">
                                        <div class="card-body">
                                            <div class="p-2">
                                                ...
                                                <h1 class="mt-3">$99 <span class="text-muted font-size-16 fw-medium">/
                                                        Month</span></h1>
                                                <p class="text-muted mt-3 font-size-15">For small teams trying out Satria Piranti Perkasa for
                                                    an unlimited
                                                    period of time</p>
                                ...
                                <div class="col-lg-3">
                                    <div class="card mb-0">
                                        <div class="card-body">
                                            <div class="p-2">
                                                <h5 class="font-size-16">Starter</h5>
                                                <h1 class="mt-3">$129 <span class="text-muted font-size-16 fw-medium">/
                                                        Yearly</span></h1>
                                                <p class="text-muted mt-3 font-size-15">For small teams trying out Satria Piranti Perkasa for
                                                    an unlimited
                                                    period of time</p>
                                ...
                                <div class="col-lg-3">
                                    <div class="card mb-0">
                                        <div class="card-body">
                                            <div class="p-2">
                                                <h5 class="font-size-16">Professional</h5>
                                                <h1 class="mt-3">$149 <span class="text-muted font-size-16 fw-medium">/
                                                        Yearly</span></h1>
                                                <p class="text-muted mt-3 font-size-15">For larger businesses or those with
                                                    onal administration needs</p>
                                                <div class="mt-4 pt-2 text-muted">
                                        ...
                                        <div class="card-body">
                                            <div class="p-2">
                                                ...
                                                <h1 class="mt-3 text-white">$179 <span
                                                        class="text-white font-size-16 fw-medium">/ Yearly</span></h1>
                                                <p class="text-white-50 mt-3 font-size-15">For extra large businesses or
                                                    those in regulated industries</p>
                                                <div class="mt-4 pt-2 text-white">
                                                    <p class="mb-3 font-size-15"><i
                                ...
                                <div class="col-lg-3">
                                    <div class="card mb-0">
                                        <div class="card-body">
                                            <div class="p-2">
                                                <h5 class="font-size-16">Unlimited</h5>
                                                <h1 class="mt-3">$199 <span class="text-muted font-size-16 fw-medium">/
                                                        Yearly</span></h1>
                                                <p class="text-muted mt-3 font-size-15">For small teams trying out Satria Piranti Perkasa for
                                                    an unlimited
                                                    period of time</p>
        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-3">
                            <div class="nav flex-column nav-pills pricing-tab-box" id="v-pills-tab" role="tablist"
                                aria-orientation="vertical">
                                <a class="nav-link mb-3 active" id="v-pills-tab-one" data-bs-toggle="pill"
                                    href="#v-price-one" role="tab" aria-controls="v-price-one" aria-selected="true">
                                    <div class="d-flex align-items-center">
                                        <i class="bx bx-check-circle h3 mb-0 me-4"></i>
                                        <div class="flex-1">
                                            <h2 class="fw-medium">$29 <span class="text-muted font-size-15">/ Month
                                                    Plans</span></h2>
                                            <p class="fw-normal mb-0 text-muted">For small teams trying out Satria Piranti Perkasa for an
                                                unlimited period of time</p>
                                        </div>
                                    </div>
                                </a>
                                <a class="nav-link mb-3" id="v-pills-tab-two" data-bs-toggle="pill" href="#v-price-two"
                                    role="tab" aria-controls="v-price-two" aria-selected="false">
                                    <div class="d-flex align-items-center">
                                        <i class="bx bx-check-circle h3 mb-0 me-4"></i>
                                        <div class="flex-1">
                                            <h2 class="fw-medium">$79 <span class="text-muted font-size-15">/ Month
                                                    Plans</span></h2>
                                            <p class="fw-normal mb-0 text-muted">For larger businesses or those with onal
                                                administration needs</p>
                                        </div>
                                    </div>
                                </a>
                                <a class="nav-link" id="v-pills-tab-three" data-bs-toggle="pill" href="#v-price-three"
                                    role="tab" aria-controls="v-price-three" aria-selected="false">
                                    <div class="d-flex align-items-center">
                                        <i class="bx bx-check-circle h3 mb-0 me-4"></i>
                                        <div class="flex-1">
