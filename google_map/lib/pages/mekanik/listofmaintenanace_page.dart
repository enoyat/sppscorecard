...
class ListOfMaintenancePage extends StatefulWidget {
  const ListOfMaintenancePage({super.key});

  @override
  State<ListOfMaintenancePage> createState() => _ListOfMaintenancePage();
}

class _ListOfMaintenancePage extends State<ListOfMaintenancePage> {
  int selectedindex = 0;
  String? nama = "";
  int? userid;
  ...
  void refreshData() async {
    ...
    await TroubleDio().listoftrouble(1).then((value) {
      setState(() {
        _trouble = value;
        isLoading = false;
      });
