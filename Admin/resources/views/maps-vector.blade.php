...
@section('script')
    <script src="{{ URL::asset('build/libs/jquery-vectormap/jquery-vectormap.min.js') }}">
    </script>
    <!-- jquery.vectormap js-->
    <script src="{{ URL::asset('build/libs//admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js') }}">
    </script>
    <script
