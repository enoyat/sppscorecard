...
@section('css')
    ...
    <link rel="stylesheet"
        href="{{ URL::asset('build/libs/twitter-bootstrap-wizard/twitter-bootstrap-wizard.min.css') }}">
...
@section('script')
    ...
    <script src="{{ URL::asset('build/libs/twitter-bootstrap-wizard/twitter-bootstrap-wizard.min.js') }}"></script>
    {{-- <script src="{{ URL::asset('/buildlibs/twitter-bootstrap-wizard/prettify.js') }}"></script> --}}
