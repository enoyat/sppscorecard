...
{{-- <link href="{{ URL::asset('/build/css/main.css') }}" rel="stylesheet" type="text/css" /> --}}
                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-center mt-5">
                            <div class="col-lg-12 col-sm-6">
                                <img src="build/images/undraw-calendar.svg" alt="" class="img-fluid d-block">
                            </div>
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body p-4">
                        <form class="needs-validation" name="event-form" id="form-event" novalidate>
                            ...
                            <div class="row mt-2">
                                <div class="col-6">
                                    <button type="reset" class="btn btn-danger" data-bs-dismiss="modal" id="btn-delete-event">Delete</button>
                                </div>
