...
@section('css')
    ...
    <!-- choices css -->
    <link href="{{ URL::asset('build/libs/choices.js/choice-js.min.css') }}" rel="stylesheet" type="text/css" />

    <!-- color picker css -->
    <link rel="stylesheet" href="{{ URL::asset('build/libs/@simonwep/@simonwep.min.css') }}" />
    <!-- 'classic' theme -->
...
@section('script')
    ...
    <!-- choices js -->
    <script src="{{ URL::asset('build/libs/choices.js/choice-js.min.js') }}"></script>

    <!-- color picker js -->
    {{-- <script src="{{ URL::asset('build/libs/@simonwep/pickr/pickr.min.js') }}"></script> --}}
    <script src="{{ URL::asset('build/libs/@simonwep/@simonwep.min.js') }}"></script>
