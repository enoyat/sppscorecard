...
@section('css')
    ...
    <link href="{{ URL::asset('build/libs/rwd-table/rwd-table.min.css') }}" rel="stylesheet" type="text/css" />
...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title') Responsive Tables @endslot
    @endcomponent
    <div class="row">
        <div class="col-12">
            <div class="card">
...
@section('script')
    ...
    <!-- Responsive Table js -->
    <script src="{{ URL::asset('build/libs/rwd-table/rwd-table.min.js') }}"></script>
