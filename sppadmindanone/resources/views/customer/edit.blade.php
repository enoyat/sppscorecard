        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('customer.update',$customer->kdcustomer) }}" method="POST">
                        @method('PUT')
                            ...
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" value="{{ $customer->kdcustomer }}" name="kdcustomer"
                                            id="kdcustomer">
                                    </div>
                                    <div class="mb-3">
                                        <label for="example-password-input" class="form-label">Name</label>
                                        <input class="form-control" type="text" value="{{ $customer->namacustomer }}" name="namacustomer"
                                            id="namacustomer">
                                    </div>
                                    <div class="mb-3">
                                        <label for="example-password-input" class="form-label">LOCATION</label>
                                        <input class="form-control" type="text" value="{{ $customer->location }}" name="location"
                                            id="location">
                                    </div>
                                    <div class="mb-3">
