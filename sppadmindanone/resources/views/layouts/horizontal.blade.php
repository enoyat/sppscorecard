        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="build/images/logo-sm.svg" alt="" height="24"> <span class="logo-txt">SPP</span>
                    </span>
                </a>
                                    ...
                                    <div class="col-lg-4">
                                        <div>
                                            ...
                                            <div>
                                                ...
                                                <a href="extended-session-timeout" class="dropdown-item" data-key="t-session-timeout">Session Timeout</a>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-invoice">
                                    <a href="apps-invoices-list" class="dropdown-item" data-key="t-invoice-list">Invoice
                                        List</a>
                                    <a href="apps-invoices-detail" class="dropdown-item" data-key="t-invoice-detail">Invoice Detail</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                    ...
                                    <a href="apps-contacts-list" class="dropdown-item" data-key="t-user-list">User
                                        List</a>
                                    <a href="apps-contacts-profile" class="dropdown-item" data-key="t-profile">Profile</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle d-flex justify-content-between align-items-center" href="#" id="topnav-contact" role="button">
                                    <span data-key="t-blog" class="">Blog</span>
                                    <span class="badge bg-soft-danger text-danger">New</span>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                    <a href="apps-blog-grid" class="dropdown-item" data-key="t-blog-grid">Blog Grid</a>
                                    <a href="apps-blog-list" class="dropdown-item" data-key="t-blog-list">Blog List</a>
                                    <a href="apps-blog-detail" class="dropdown-item" data-key="t-blog-details">Blog Details</a>
                                </div>
                            </div>
                        </div>
                    </li>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-form">
                                    <a href="form-elements" class="dropdown-item" data-key="t-form-elements">Basic
                                        Elements</a>
                                    <a href="form-validation" class="dropdown-item" data-key="t-form-validation">Validation</a>
                                    <a href="form-advanced" class="dropdown-item" data-key="t-form-advanced">Advanced
                                        Plugins</a>
                                    <a href="form-editors" class="dropdown-item" data-key="t-form-editors">Editors</a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-table">
                                    ...
                                    <a href="tables-datatable" class="dropdown-item" data-key="t-data-tables">Data
                                        Tables</a>
                                    <a href="tables-responsive" class="dropdown-item" data-key="t-responsive-table">Responsive</a>
                                    <a href="tables-editable" class="dropdown-item" data-key="t-editable-table">Editable</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                    ...
                                    <a href="charts-echart" class="dropdown-item" data-key="t-e-charts">E
                                        charts</a>
                                    <a href="charts-chartjs" class="dropdown-item" data-key="t-chartjs-charts">Chartjs</a>
                                    <a href="charts-knob" class="dropdown-item" data-key="t-knob-charts">Jquery
                                        Knob</a>
                                    <a href="charts-sparkline" class="dropdown-item" data-key="t-sparkline-charts">Sparkline</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-icons">
                                    ...
                                    <a href="icons-dripicons" class="dropdown-item" data-key="t-dripicons">Dripicons</a>
