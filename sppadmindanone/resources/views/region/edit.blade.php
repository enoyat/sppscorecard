                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="id" id="id" value="{{ $region->id }}"
                                        placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="example-text-input" class="form-label">Region</label>
                                    <input class="form-control" type="text" name="namasitename"
                                        value="{{ $region->namasitename }}" id="namasitename" placeholder="">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="idcbu"
                                        id="idcbu">
                                        @if ($region->parent->namasitename!=null)
                                            <option value="{{ $region->parentid }}" selected>{{ $region->parent->namasitename }}
                                            </option>
                                        @endif
