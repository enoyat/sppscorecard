                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" value="{{ $sparepart->produkcategory }}" name="produkcategory" id="produkcategory">
                                </div>
                                <div class="mb-3">
                                    <label for="example-password-input" class="form-label">Part No</label>
                                    <input class="form-control" type="text" value="{{ $sparepart->partno }}" name="partno" id="partno">
                                </div>
                                <div class="mb-3">
                                    <label for="example-password-input" class="form-label">Part Name</label>
                                    <input class="form-control" type="text" value="{{ $sparepart->partname }}" name="partname" id="partname">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" value="{{ $sparepart->merkjenisforklift }}" name="merkjenisforklift" id="merkjenisforklift">
                                </div>
                                <div class="mb-3">
                                    <label for="example-password-input" class="form-label">Description</label>
                                    <input class="form-control" type="text" value="{{ $sparepart->description }}" name="description" id="description">
                                </div>
                                <div class="mb-3">
